...
public class AsyncLogger extends Logger implements EventTranslatorVararg<RingBufferLogEvent>
{
    ...
    {
        abstract void log(final String p0, final StackTraceElement p1, final Level p2, final Marker p3, final Message p4, final Throwable p5);
        
        abstract void log(final String p0, final Level p1, final Marker p2, final Message p3, final Throwable p4);
    }
}
