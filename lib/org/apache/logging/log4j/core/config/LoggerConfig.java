...
public class LoggerConfig extends AbstractFilterable implements LocationAware
{
    ...
    public void log(final String loggerName, final String fqcn, final Marker marker, final Level level, final Message data, final Throwable t) {
        ...
        final LogEvent logEvent = (this.logEventFactory instanceof LocationAwareLogEventFactory) ? ((LocationAwareLogEventFactory)this.logEventFactory).createEvent(loggerName, marker, fqcn, this.requiresLocation() ? StackLocatorUtil.calcLocation(fqcn) : null, level, data, props, t) : this.logEventFactory.createEvent(loggerName, marker, fqcn, level, data, props, t);
        try {
    ...
    public void log(final String loggerName, final String fqcn, final StackTraceElement location, final Marker marker, final Level level, final Message data, final Throwable t) {
        ...
        final LogEvent logEvent = (this.logEventFactory instanceof LocationAwareLogEventFactory) ? ((LocationAwareLogEventFactory)this.logEventFactory).createEvent(loggerName, marker, fqcn, location, level, data, props, t) : this.logEventFactory.createEvent(loggerName, marker, fqcn, level, data, props, t);
        try {
            this.log(logEvent, LoggerConfigPredicate.ALL);
        }
        finally {
    ...
    protected enum LoggerConfigPredicate
    {
        ...
        abstract boolean allow(final LoggerConfig p0);
    }
}
